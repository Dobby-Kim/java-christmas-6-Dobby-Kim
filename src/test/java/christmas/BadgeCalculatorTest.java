...
class BadgeCalculatorTest {
    ...
    void testCalculateEventBadgeNone() {
        ...
        assertEquals(EventBadge.NONE, BadgeCalculator.calculateEventBadge(discountAmount));
    }
    ...
    void testCalculateEventBadgeStar() {
        ...
        assertEquals(EventBadge.STAR, BadgeCalculator.calculateEventBadge(discountAmount));
    }
    ...
    void testCalculateEventBadgeTree() {
        ...
        assertEquals(EventBadge.TREE, BadgeCalculator.calculateEventBadge(discountAmount));
    }
    ...
    void testCalculateEventBadgeSanta() {
        ...
        assertEquals(EventBadge.SANTA, BadgeCalculator.calculateEventBadge(discountAmount));
    }
